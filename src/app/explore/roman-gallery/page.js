...
export default function RomanGalleryPage() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      if (!storedUser) {
        router.push('/login?redirect=/explore/roman-gallery');
        return;
      }
      ...
      <main className="flex-1 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 mb-8">
            Explore our collection of classical Roman sculptures, including some of the most celebrated works from antiquity.
          </p>
